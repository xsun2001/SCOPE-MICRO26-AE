...
9. **Figure 20 — Effect of shape constraints.** Reproduces the width-16 constrained-versus-unconstrained ablation on nine functions. The bundled validation contains 18/18 matching configurations and a 47.1x--976.3x MSE improvement.
...
12. **Table 5 — OSTQuant low-bit model quality.** Reproduces perplexity and four-task mean accuracy for Llama-2-7B and Llama-3-8B under W6A6 and W4A4, comparing OSTQuant, SCNA-8/16/32, and the BF16 baseline. The bundled validation contains 20/20 matching table entries.
