...
class GeLU(Operator):
    ...
    def roofline_model(self, pcb_module: Device):
        ...
        vector_latency = pcb_module.compute_module.vector_latency(M * 10)
        mufu_latency = pcb_module.compute_module.mufu_latency(M)
        compute_latency = vector_latency + mufu_latency
    ...
    def compile_and_simulate(self, pcb_module: Device, compile_mode: str):
        ...
        compute_latency = (
            vector_unit.vector_cycles(M * 10) + vector_unit.mufu_cycles(M)
        ) / pcb_module.compute_module.core_count / pcb_module.compute_module.clock_freq
