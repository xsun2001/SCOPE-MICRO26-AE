"""
PyTorch LLaMA attention with attention-exp replaced by quantized-domain GQA-LUT.
"""
...
from ...common import ScalarGqaLut
...
class LlamaAttention_GQALUT(nn.Module):
    def __init__(self, args, config: LlamaConfig, layer_idx: int):
        ...
        self.exp_lut = ScalarGqaLut(
            args.approx_exp_lut_path,
            decimal_bits=args.approx_exp_lut_bits,
    ...
    def forward(
        ...
        **kwargs,
        ...
        if position_embeddings is None:
            raise ValueError("LlamaAttention_GQALUT requires precomputed position_embeddings.")
        ...
        if self.config._attn_implementation != "eager":
            raise ValueError("Only eager attention is supported for LlamaAttention_GQALUT")
