"""
PyTorch OPT attention with attention-exp replaced by a piecewise-linear NNLUT.
"""
...
class OPTAttention_NNLUT(nn.Module):
    def __init__(
        self,
        args,
        config: OPTConfig,
    ...
    def forward(
        ...
        exp_elements_approx = self.exp_lut(valid_shifted_logits_reshaped)
        if self.args.quant_approx_activations:
