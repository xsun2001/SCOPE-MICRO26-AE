...
`expected/paper_table4.csv` contains the exact MSE and MAE entries extracted from Table 4. The shared `../../train/` directory preserves every related implementation found in the workspace: the paper-era SCNA trainer, GQA-LUT, NLI, NN-LUT, and a separate Taylor diagnostic.
