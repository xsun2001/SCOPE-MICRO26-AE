...
| TPUv3 INT8 | int8 | 32.00 | 306.152 | 143.634 | 126.387 | matmul_pair (143.334 ms) | fused_core (126.087 ms) | 1.136x |
| TPUv4 FP16 | fp16 | 64.00 | 362.271 | 129.593 | 96.685 | matmul_pair (129.293 ms) | fused_core (96.385 ms) | 1.340x |
| TPUv4 INT8 | int8 | 64.00 | 356.981 | 128.610 | 104.416 | matmul_pair (128.310 ms) | fused_core (104.116 ms) | 1.232x |
| TPUv5e FP16 | fp16 | 32.00 | 514.407 | 181.310 | 135.239 | matmul_pair (181.010 ms) | fused_core (134.939 ms) | 1.341x |
| TPUv5e INT8 | int8 | 32.00 | 374.148 | 90.123 | 73.362 | matmul_pair (89.823 ms) | fused_core (73.062 ms) | 1.228x |
| TPUv5p FP16 | fp16 | 32.00 | 175.651 | 77.876 | 58.131 | matmul_pair (77.576 ms) | fused_core (57.831 ms) | 1.340x |
| TPUv5p INT8 | int8 | 32.00 | 115.892 | 38.795 | 31.612 | matmul_pair (38.495 ms) | fused_core (31.312 ms) | 1.227x |
| TPUv6e FP16 | fp16 | 128.00 | 214.050 | 69.646 | 41.082 | matmul_pair (69.346 ms) | fused_core (40.782 ms) | 1.695x |
| TPUv6e INT8 | int8 | 128.00 | 180.116 | 58.051 | 30.278 | softmax (57.751 ms) | fused_core (29.978 ms) | 1.917x |
