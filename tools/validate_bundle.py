...
EXPERIMENTS = {
    ...
    "fig-16-end-to-end-quality": ("actual-results/2026-07-13_ae-validation/analysis/validation.json", "pass", 80),
    "tbl-5-ostquant-quality": ("actual-results/2026-07-13_ae-validation/analysis/validation.json", "pass", 16),
    "fig-17-neuron-scalability": ("actual-results/2026-07-13_ae-validation/analysis/validation.json", "pass", 36),
    "fig-20-shape-constraints": ("actual-results/2026-07-13_ae-validation/analysis/validation.json", "pass", 18),
}
...
def main() -> int:
    ...
    for name, validation in EXPERIMENTS.items():
        ...
        if validation:
            ...
            payload = json.loads((directory / "actual-results/2026-07-13_ae-validation/validation.json").read_text())
